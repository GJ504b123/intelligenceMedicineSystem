  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route path="/other" element={checkRouteAccess('doctor', <div className="text-center text-xl">Other Page - Coming Soon</div>)} />
        <Route path="/records/create" element={checkRouteAccess('doctor', <RecordCreatePage />)} />
        <Route path="/records/create/:patientId" element={checkRouteAccess('doctor', <RecordCreatePage />)} />
        
        {/* 患者端路由 */}
        <Route path="/patient" element={checkRouteAccess('patient', <PatientHome />)} />
        ...
        <Route path="/patient/ai-chat" element={checkRouteAccess('patient', <PatientAIChat />)} />
        
        {/* 第三方验证机构路由 */}
        <Route path="/verify" element={checkRouteAccess('third-party', <ThirdPartyVerifyHome />)} />
        <Route path="/verify/files" element={checkRouteAccess('third-party', <FileVerifyPage />)} />
        ...
        <Route path="/verify/certificate" element={checkRouteAccess('third-party', <CertificateVerifyPage />)} />
        <Route path="/verify/result" element={checkRouteAccess('third-party', <VerificationResultPage />)} />
